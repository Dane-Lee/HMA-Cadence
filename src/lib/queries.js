...
export const listIssuedPlanKeys       = db.listIssuedPlanKeys;
export const bindRecognitionKey       = db.bindRecognitionKey;
export const fetchByRecognitionKey    = db.fetchByRecognitionKey;
